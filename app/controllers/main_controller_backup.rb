...
class MainController < ApplicationController
  def scrape
    ...
    threads << Thread.new do
      @ga_reviews = Rails.cache.fetch(:ga_reviews) do
        fetch_site_data("http://www.greatandhra.com/reviews.php", "div.movies_page_news a", 
    ...
    threads << Thread.new do
      @ib_reviews = Rails.cache.fetch(:ib_reviews) do
        fetch_site_data("http://idlebrain.com/movie/archive/index.html", 
    ...
    threads << Thread.new do
      @gt_reviews = Rails.cache.fetch(:gt_reviews) do
        fetch_site_data("http://www.gulte.com/moviereviews", 
